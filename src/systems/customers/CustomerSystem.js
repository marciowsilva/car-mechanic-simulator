// src/systems/CustomerSystem.js - Gerencia clientes e jobs

export class CustomerSystem {
  constructor() {
    console.log("👥 Inicializando CustomerSystem...");
  ...
  completeJob(quality) {
    ...
    customer.visits++;
    customer.satisfaction = Math.floor(
      (customer.satisfaction + satisfaction) / 2,
    );
  ...
  getStats() {
    ...
    const avgSatisfaction =
      this.customers.reduce((sum, c) => sum + c.satisfaction, 0) /
      totalCustomers;
