...
import { gameState, scene3D, upgradeSystem, achievementSystem, db, audioManager, inventory, specializationSystem } from './game.js';
...
export class UIManager {
    ...
    updateJobInfo() {
        ...
        const difficultyText = gameState.currentJob.difficulty === 'easy' ? 'Fácil' : 
    ...
    updatePartsList() {
        ...
        Object.entries(gameState.currentCar.parts).forEach(([partName, partData]) => {
            ...
            const repairEfficiency = upgradeSystem?.calculateRepairEfficiency(toolStats.repair) || 0;
