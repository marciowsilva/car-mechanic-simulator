// database.js
import { gameState, upgradeSystem, achievementSystem } from './game.js';
...
export class Database {
    ...
    loadUpgrades() {
        ...
        request.onsuccess = (event) => {
            if (event.target.result) {
                ...
                upgradeSystem.workshopUpgrades = data.workshopUpgrades || upgradeSystem.workshopUpgrades;
                upgradeSystem.skillUpgrades = data.skillUpgrades || upgradeSystem.skillUpgrades;
            }
        };
    }
    ...
    loadAchievements() {
        ...
        request.onsuccess = (event) => {
            if (event.target.result) {
                const data = event.target.result;
                achievementSystem.achievements = data.achievements || achievementSystem.achievements;
            }
        };
    }
